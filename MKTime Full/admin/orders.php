          ...
          <div class = "container"> 
            <div class = "col-lg-12 col-md-12 col-sm-12">
                ...
                <table class="table" data-page-length='10'>
                  <thead>
                    <tr>
                      <th scope="col" colspan="1" name = "order_id">Order ID</th>
                      <th scope="col" colspan="1" name = "customer_id">Customer ID</th>
                      <th scope="col" colspan="1" name = "total_price">Total Price</th>
                      <th scope="col" colspan="1" name = "order_date">Order Date</th>
                  ...
                  <tbody>
                        ...
                        <tr>
                            <!-- FETCHING DATA FROM EACH
                                ROW OF EVERY COLUMN -->
                            <td colspan="1"><?php echo $rows['order_id'];?></td>
                            <td colspan="1"><?php echo $rows['customer_id'];?></td>
                            <td colspan="1"><?php echo $rows['total_price'];?></td>
                            <td colspan="1"><?php echo $rows['order_date'];?></td>

                            <td colspan="1"><a class = "btn btn-del" id = "btn" type = "delete"  
                                              onclick="return confirm('Are you sure you want to delete this order?')"
                                              href="delete.php?order_id=<?php echo $rows['order_id'];?>">Delete</a></td>
                        </tr>
